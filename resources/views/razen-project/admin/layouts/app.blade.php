...
<html lang="en" data-footer="true">
    <head>
        @include('razen-project.admin.layouts.head')
    </head>

    <body>
        <div id="root">
            @include('razen-project.admin.layouts.nav')

            <main>
                @yield('content')
            </main>
            @include('razen-project.admin.layouts.footer')
        </div>
        ...
        @include('razen-project.admin.layouts.js')
    </body>
</html>
