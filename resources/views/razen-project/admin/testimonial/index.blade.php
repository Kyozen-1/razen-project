...
@section('title', 'Admin - Razen Project | Testimonial')
...
@section('content')
        ...
        <div class="col-12 col-md-7">
            ...
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-project.admin.testimonial.index') }}">Testimonial</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
    ...
    <div class="row mb-3">
        <div class="col-6" style="text-align:left">
            <a href="{{ route('beranda') }}#testimonials" class="btn btn-icon waves-effect waves-light btn-secondary" target="blank"><i class="fas fa-pager"></i> Preview</a>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTables = $('#testimonial_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-project.admin.testimonial.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $('#testimonial_form').on('submit', function(e){
            ...
            {
                $.ajax({
                    url: "{{ route('razen-project.admin.testimonial.store') }}",
                    method: "POST",
            ...
            {
                $.ajax({
                    url: "{{ route('razen-project.admin.testimonial.update') }}",
                    method: "POST",
                    data: new FormData(this),
                    dataType: "json",
                    contentType: false,
        ...
        $(document.body).on('click', '.detail', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{ url('/razen-project/testimonial/detail/') }}" + '/' + id,
                dataType: "json",
                success: function(data)
                {
                    ...
                    $('#detail_foto').attr('src', "{{ asset('images/razen-project/foto-testimoni') }}" + '/' + data.result.foto);
                    $('#detail').modal('show');
                }
            });
        });
        ...
        $(document).on('click', '.edit', function(){
            ...
            $('#form_result').html('');
            $.ajax({
                url: "{{ url('/razen-project/testimonial/edit') }}"+'/'+id,
                dataType: "json",
                success: function(data)
                {
                    ...
                    var lokasi_foto = "{{ asset('images/razen-project/foto-testimoni') }}"+'/'+data.result.foto;
        ...
        $('#ok_button').click(function(){
            $.ajax({
                url: "{{ url('/razen-project/testimonial/destroy') }}"+'/'+user_id,
                beforeSend: function(){
