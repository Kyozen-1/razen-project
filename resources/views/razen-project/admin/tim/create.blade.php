...
@section('title', 'Admin - Razen Project | Tim | Create')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Tim | Create</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('razen-project.admin.tim.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="mb-3 position-relative form-group">
                    ...
                    <input type="file" class="dropify" name="gambar" data-height="150" data-allowed-file-extensions="png jpg jpeg webp" data-show-errors="true" required>
                </div>
                <hr>
