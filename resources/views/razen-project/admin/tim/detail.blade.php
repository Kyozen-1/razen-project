...
@section('title', 'Admin - Razen Project | Tim | Detail')
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group position-relative mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$razen_project_section_tim->nama}}" disabled>
                    </div>
                    <div class="form-group position-relative mb-3">
                        <label class="form-label">Jabatan</label>
                        <input type="text" class="form-control" value="{{$razen_project_section_tim->master_jabatan_tim->nama}}" disabled>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group position-relative mb-3" style="text-align: center">
                        ...
                        <br>
                        <img src="{{ asset('images/razen-project/gambar-tim/'.$razen_project_section_tim->gambar) }}" alt="" style="height: 10rem;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        @foreach ($pivot['data'] as $item)
                            <tr>
                                <td>{{$item->master_media_sosial->nama}}</td>
                                <td>{{$item->tautan}}</td>
                            </tr>
                        @endforeach
                    </tbody>
